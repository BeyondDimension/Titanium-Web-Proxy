...
using Titanium.Web.Proxy.Certificates.Makers;
    ...
    private ICertificateMaker certEngine
    {
        get
        {
            certEngineValue ??= engine switch
                {
                    CertificateEngine.BouncyCastle => new BCCertificateMaker(ExceptionFunc, CertificateValidDays),
                    CertificateEngine.BouncyCastleFast => new BCCertificateMakerFast(ExceptionFunc, CertificateValidDays),
                    _ => new WinCertificateMaker(ExceptionFunc, CertificateValidDays),
                };
